...
atm_data = pd.read_csv('./data/lecture3/atm_data.csv', index_col=0, parse_dates=True)  # это файлик smsb
costs = pd.read_csv('./data/lecture3/costs.csv', index_col=0, encoding='cp1251')
atm_dm_availability = pd.read_csv('./data/lecture3/atm_dm_availability.csv', index_col=0)
atm_dm_availability = atm_dm_availability[atm_dm_availability.availability == 'Encash']

# atm intraday
atm_intraday = pd.read_csv('./data/lecture3/atm_intraday.csv', index_col=0, parse_dates=True)
